...
OUTPUT_DIR = "/home/joberant/NLP_2425b/maozhaim/NLP/gpt2/fine-tuning-results"
MODEL_SAVE_PATH = "/home/joberant/NLP_2425b/maozhaim/NLP/gpt2/gpt2-fine-tuned-model"
MAX_LEN = 512
EPOCHS = 5
LEARNING_RATE = 5e-6
...
tokenizer = AutoTokenizer.from_pretrained(model_name) # Load tokenizer for GPT-2 (does not have pad_token by default)
tokenizer.pad_token = tokenizer.eos_token  # Assign EOS token as PAD

# Load GPT-2 model for sequence classification with 2 labels (Human/AI)
...
model.config.pad_token_id = tokenizer.pad_token_id # Ensure padding token is recognized by the model
model.to(device)
print()
